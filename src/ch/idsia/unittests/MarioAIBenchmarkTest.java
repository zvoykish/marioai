...
public class MarioAIBenchmarkTest extends TestCase
{
    ...
    {
        final CmdLineOptions cmdLineOptions = new CmdLineOptions("-vis off -lc 0 -ag ch.idsia.ai.controllers.ForwardJumpingAgent");
        assertNotNull(cmdLineOptions.getAgent());
        assertEquals(cmdLineOptions.getAgent().getName(), "ForwardJumpingAgent");
        assertEquals(cmdLineOptions.getAgentLoadFullName(), "ch.idsia.ai.controllers.ForwardJumpingAgent");
    }

    @Test
    public void testForwardJumpingAgentFitnessWithoutCreatures()
    {
        final CmdLineOptions cmdLineOptions = new CmdLineOptions("-vis off -le 0 -ag ch.idsia.ai.controllers.ForwardJumpingAgent -echo on");
    ...
    {
        final CmdLineOptions cmdLineOptions = new CmdLineOptions("-vis off -le 0 -ag ch.idsia.ai.controllers.ForwardAgent -echo on");
        final BasicTask basicTask = new BasicTask(cmdLineOptions);
        basicTask.reset(cmdLineOptions);
        basicTask.runOneEpisode();
        System.out.println(basicTask.getEnvironment().getEvaluationInfoAsString());
    ...
    {
        final CmdLineOptions cmdLineOptions = new CmdLineOptions("-vis off -ag ch.idsia.ai.controllers.ForwardJumpingAgent -echo on");
        final BasicTask basicTask = new BasicTask(cmdLineOptions);
        basicTask.reset(cmdLineOptions);
        basicTask.runOneEpisode();
        System.out.println(basicTask.getEnvironment().getEvaluationInfoAsString());
    ...
    {
        final CmdLineOptions cmdLineOptions = new CmdLineOptions("-vis off -ag ch.idsia.ai.controllers.ForwardAgent -echo on");
        final BasicTask basicTask = new BasicTask(cmdLineOptions);
        basicTask.reset(cmdLineOptions);
        basicTask.runOneEpisode();
        System.out.println(basicTask.getEnvironment().getEvaluationInfoAsString());
