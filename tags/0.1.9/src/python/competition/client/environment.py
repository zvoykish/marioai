...
class Environment(object):
    ...
    def getSensors(self):
        """ the currently visible state of the levelScene (the observation may be
    ...
    def performAction(self, action):
        """ perform an action on the levelScene that changes it's internal state (maybe stochastically)
